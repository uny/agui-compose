...
kotlin {
    ...
    android {
        namespace = "dev.ynagai.agui.core"
    ...
    sourceSets {
        commonMain.dependencies {
            ...
            // `api`: this module's entry point takes upstream's `BaseEvent`, so a consumer holds
            // upstream types to call it at all.
            //
            // Upstream declares its own coroutines and serialization dependencies as
            // `implementation`, so they do not arrive transitively -- measured, not assumed.
            // Hence both are declared here as well.
            api(libs.agui.core)
